                    ...
                    <div class="col-md-12" style="margin-top: 16px;">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                $data = $mysqli->query("SELECT * FROM view_agenda WHERE nama_ruangan LIKE '%$keyword%' OR pejabat LIKE '%$keyword%' OR fotografer LIKE '%$keyword%'");
                                $jumlah_data = mysqli_num_rows($data);
                                $total_halaman = ceil($jumlah_data / $batas);

                                $data_agenda = $mysqli->query("SELECT * FROM view_agenda WHERE nama_ruangan LIKE '%$keyword%' OR pejabat LIKE '%$keyword%' OR fotografer LIKE '%$keyword%' ORDER BY id_agenda DESC LIMIT $halaman_awal, $batas");
                                ...
                                <?php while ($row = $data_agenda->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;"><?= $row['pejabat']; ?></td>
                                        <td style="vertical-align: middle;"><?= $row['fotografer']; ?></td>

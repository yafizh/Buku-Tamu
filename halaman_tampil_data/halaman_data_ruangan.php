        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-headline">
                ...
                <div class="panel-body">
                    <div class="col-md-8">
                        <a href="index.php?page=tambah_ruangan" class="btn btn-primary">Tambah Ruangan</a>
                    </div>
                    <div class="col-md-4">
                                ...
                                <?php while ($row = $data_ruangan->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="index.php?page=delete_ruangan&id_ruangan=<?= $row['id_ruangan']; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin ingin menghapus data ini?')"><span class="lnr lnr-trash"></span></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
                        ...
                        <?php if ($total_halaman > 1) : ?>
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    <?php if ($sebelumnya > 0) : ?>
                                        <li>
                                            <a href="index.php?page=data_ruangan&halaman=<?= $sebelumnya; ?>" aria-label="Previous">
                                    ...
                                    <?php for ($i = 1; $i <= $total_halaman; $i++) : ?>
                                        <?php if ($i == $halaman) : ?>
                                            <li class="active"><a href="index.php?page=data_ruangan&halaman=<?= $i; ?>"><?= $i; ?></a></li>
                                        <?php else : ?>
                                            <li><a href="index.php?page=data_ruangan&halaman=<?= $i; ?>"><?= $i; ?></a></li>
                                        <?php endif; ?>
                                    <?php endfor; ?>
                                    <?php if ($selanjutnya <= $total_halaman) : ?>
                                        <li>
                                            <a href="index.php?page=data_ruangan&halaman=<?= $selanjutnya; ?>" aria-label="Next">

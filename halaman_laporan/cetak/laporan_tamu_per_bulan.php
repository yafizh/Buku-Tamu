    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <?php
                $no = 1;
                $result = $mysqli->query("SELECT * FROM view_buku_tamu WHERE (MONTH(tanggal)='$bulan' AND YEAR(tanggal)='$tahun') AND id_ruangan LIKE '%$id_ruangan%' AND id_user LIKE '%$id_user%' ORDER BY id_tamu DESC");
                ?>
